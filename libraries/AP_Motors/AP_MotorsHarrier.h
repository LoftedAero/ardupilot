/// @file	AP_MotorsHarrier.h
/// @brief	Motor control class for Harrier STOVL
#pragma once
...
/// @class      AP_MotorsHarrier
class AP_MotorsHarrier : public AP_MotorsMulticopter {
public:

    /// Constructor
    AP_MotorsHarrier(uint16_t loop_rate, uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT) :
    ...
    const char* get_frame_string() const override { return "Harrier"; }
